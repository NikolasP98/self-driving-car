...
const ES = {
	...
	'RUNS': 'EJECUCIONES', 'SAVED': 'GUARDADAS', 'MAX TIER': 'NIVEL MÁXIMO', 'MANUAL / USER': 'MANUAL / USUARIO', 'READY': 'LISTO', 'PROMOTE TO': 'ASCENDER A', 'Delete this sensor': 'Eliminar este sensor',
	'Smart promotion requires two consecutive runs above the next fitness milestone': 'La promoción inteligente exige dos ejecuciones consecutivas por encima del siguiente hito de aptitud', 'The course is already at its highest tier': 'El circuito ya está en su nivel máximo',
